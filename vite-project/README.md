...
_Современный интерфейс с фильтрами и каталогом жилья_

### 🔐 Страница входа

![Страница входа](screenshots/login-page.png)
_Элегантная форма авторизации с поддержкой темной темы_

### 🏡 Детали объявления

![Детали объявления](screenshots/listing-details.png)
_Подробная информация с галереей и формой бронирования_

### 🌙 Темная тема

![Темная тема](screenshots/dark-theme.png)
_Комфортный интерфейс для использования в темное время суток_

### 📱 Мобильная версия

![Мобильная версия](screenshots/mobile-view.png)
_Адаптивный дизайн для всех устройств_
...
- ✅ **Современный дизайн** — Следует принципам Material Design
...
1. Создайте [Issue](https://github.com/your-username/travel-app/issues)
...
- **Feature-Sliced Design** — за методологию архитектуры
